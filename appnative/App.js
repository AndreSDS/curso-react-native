...
const App = (props) => {
  const [frase, setFrases] = useState('');
  ...
  const abreBiscoito = () => {
    ...
    let numeroAleatório = Math.floor(Math.random() * frases.length);
    setFrases(`"${frases[numeroAleatório]}"`);
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        ...
        source={
          biscoitoAberto == true
            ? require('./src/images/biscoitoAberto.png')
